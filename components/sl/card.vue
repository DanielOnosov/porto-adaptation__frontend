    ...
    <div class="product-details">
      ...
      >
        <div class="product-action">
          <a
              v-if="!isAddedToCart"
              class="btn text-white btn-dark add-cart mr-2"
              title="Add to Cart"
              @click="addCart"
          ...
          <div v-if="isAddedToCart">
            <a
                class="btn text-primary btn-dark add-cart mr-2"
                title="Посмотреть корзину"
                href="/pages/cart">Посмотреть корзину</a>
          </div>
        </div>
